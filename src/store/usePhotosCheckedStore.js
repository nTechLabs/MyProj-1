 ...
 */
const usePhotosCheckedStore = create(
...
if (process.env.NODE_ENV === 'development') {
  usePhotosCheckedStore.displayName = 'PhotosCheckedStore'
}

export default usePhotosCheckedStore

// 스토어 선택자 헬퍼 (리렌더링 최적화)
export const usePhotosCheckedIds = () => usePhotosCheckedStore(state => state.checkedIds)
export const usePhotosToggleCheck = () => usePhotosCheckedStore(state => state.toggleCheck)
export const usePhotosToggleAllCheck = () => usePhotosCheckedStore(state => state.toggleAllCheck)
export const usePhotosClearChecked = () => usePhotosCheckedStore(state => state.clearChecked)
export const usePhotosIsChecked = () => usePhotosCheckedStore(state => state.isChecked)
export const usePhotosIsAllChecked = () => usePhotosCheckedStore(state => state.isAllChecked)
export const usePhotosIsIndeterminate = () => usePhotosCheckedStore(state => state.isIndeterminate)
export const usePhotosCheckedCount = () => usePhotosCheckedStore(state => state.getCheckedCount())
