 ...
 */
const usePostsCheckedStore = create(
...
if (process.env.NODE_ENV === 'development') {
  usePostsCheckedStore.displayName = 'PostsCheckedStore'
}

export default usePostsCheckedStore

// 스토어 선택자 헬퍼 (리렌더링 최적화)
export const usePostsCheckedIds = () => usePostsCheckedStore(state => state.checkedIds)
export const usePostsToggleCheck = () => usePostsCheckedStore(state => state.toggleCheck)
export const usePostsToggleAllCheck = () => usePostsCheckedStore(state => state.toggleAllCheck)
export const usePostsClearChecked = () => usePostsCheckedStore(state => state.clearChecked)
export const usePostsIsChecked = () => usePostsCheckedStore(state => state.isChecked)
export const usePostsIsAllChecked = () => usePostsCheckedStore(state => state.isAllChecked)
export const usePostsIsIndeterminate = () => usePostsCheckedStore(state => state.isIndeterminate)
export const usePostsCheckedCount = () => usePostsCheckedStore(state => state.getCheckedCount())
